...
things = ["69","6660","6661","6662","6663","6664","6665","6666","6667","6668","6669","]
...
if kekel == "Y":
	kekel = input("put in services you want to block in format of     telnet,ftp,service_name... its pretty sad i need to explicitly state this, really goes to show the amount of brain cells you have")
	things = kekel.split(",")
